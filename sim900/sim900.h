...
#define PWR_KEY GPIO_ODR_ODR9 //Pin to set state
...
//-------------Config PWR KEY--------------------------------//
#define SET_PWR_REG CRH //can be CRL or CRH					 //
#define PWR_CNF_REG GPIO_CRH_CNF9 // to set port as out      //
#define PWR_MODE_REG0 GPIO_CRH_MODE9_0 // to set port freq   //
#define PWR_MODE_REG1 GPIO_CRH_MODE9_1 // to set port freq   //
//-----------------------------------------------------------//
...
#define CLOCK_REG RCC_APB2ENR_IOPBEN
